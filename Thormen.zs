...
Replacer.forEverything().replace(<item:electrodynamics:gearbronze>,<item:alltheores:alltheores:bronze_gear>).suppressWarnings().execute();
...
Replacer.forEverything().replace(<item:electrodynamics:gearcopper>,<item:alltheores:alltheores:copper_gear>).suppressWarnings().execute();
